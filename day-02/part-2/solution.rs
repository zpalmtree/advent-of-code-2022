...
fn load_strategy_guide(file_path: String) -> Result<Vec<StrategyGuideEntry>> {
...
fn main() {
    let guide = load_strategy_guide("../strategy_guide.txt".to_string())
    ...
    println!("Score when using strategy guide: {}", sum);
}
